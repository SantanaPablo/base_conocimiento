...
- Cree un proyecto de React con create-vite: `npm init --yes vite@latest baseconocimientofront -- --template=react`.
- Crear archivo de proyecto (`baseconocimientofront.esproj`).
